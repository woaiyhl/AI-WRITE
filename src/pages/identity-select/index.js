...
const workplaceOptions = [
  "上班族", "自由职业", "新媒体作者", "教师", "公职人员", "职业作家"
];

export default function IdentitySelect() {
  const [mainCategory, setMainCategory] = useState("adult"); // 'k12' or 'adult'
  const [selectedSub, setSelectedSub] = useState("上班族");
        ...
        <View className="px-5 pt-4 pb-24">
          ...
          <View className="flex justify-between mb-8">
            ...
            <View 
              className={classNames(
                ...
                mainCategory === 'k12' ? "border-[#00c777] bg-[#e0f2f1]" : "border-transparent shadow-sm"
              )}
            ...
            <View 
              className={classNames(
                "w-[48%] bg-white rounded-2xl p-6 flex flex-col items-center justify-center border-2 transition-all duration-200 h-40",
                mainCategory === 'adult' ? "border-[#00fa9a] bg-[#e0f7fa]/30 shadow-[0_0_15px_rgba(0,250,154,0.2)]" : "border-transparent shadow-sm"
              )}
            ...
            >
               ...
               <View className="w-16 h-16 mb-3 relative">
                 ...
                 <View className="w-10 h-10 bg-[#ffccbc] rounded-full mx-auto relative z-10 mt-4 overflow-hidden border border-[#ffccbc]">
                    <View className="w-full h-1 bg-black/10 absolute top-3"></View> {/* Glasses bridge */}
          ...
          {mainCategory === 'k12' && (
             <View className="flex items-center justify-center h-40">
                <Text className="text-gray-400">小初高选项开发中...</Text>
             </View>
          )}
